...
// /**
//  * Gera a URL completa para um arquivo público
//  * @param {string} nomeArquivo - Nome do arquivo que deseja usar
//  * @param {string} pasta - Pasta dentro de /public
//  * @param {string} arquivoPadrao - Arquivo padrão caso nomeArquivo não exista
